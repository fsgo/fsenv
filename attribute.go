...
//
//	ConfDir : 优先使用环境变量 FSENV_CONF 的值，若没有则使用默认值 {rootDir}/conf/
//	DataDir : 优先使用环境变量 FSENV_DATA 的值，若没有则使用默认值 {rootDir}/data/
//	LogDir  : 优先使用环境变量 FSENV_LOG 的值，若没有则使用默认值 {rootDir}/log/
//	TempDir : 优先使用环境变量 FSENV_TEMP 的值，若没有则使用默认值 {rootDir}/temp/
